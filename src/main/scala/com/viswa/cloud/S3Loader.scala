...
object S3Loader extends App {
  ...
  spark.sparkContext.hadoopConfiguration.set("fs.s3a.access.key", "AKIAXPRPXIKHP43VUPVP")
  spark.sparkContext.hadoopConfiguration.set("fs.s3a.secret.key", "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")
